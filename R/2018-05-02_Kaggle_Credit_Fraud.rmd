...
```{r, include = FALSE}
credit_1 <- read_csv("../Data/creditcard_1.csv")
credit_2 <- read_csv("../Data/creditcard_2.csv")

# Note: Data dims are (300,000, 30)
credit <- rbind(credit_1, credit_2)
...
##### 6.2.1.2 16x8x1, unequal weights
